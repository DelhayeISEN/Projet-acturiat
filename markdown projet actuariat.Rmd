...
```{r}
glm4 <- glm(ClaimAmount~DrivAge+VehAge+VehUsage+BonusMalus+VehBody+VehMaxSpeed+ClaimAmount+offset(ClaimInd), family=poisson("log"), data=freMPL2)
summary(glm4)
...
FORMULE  : E(N/x) = offset*exp(Bx) ?    OFFSET ? 
