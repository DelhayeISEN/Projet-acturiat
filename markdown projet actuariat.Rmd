...
|    Pour juger de la pretinence de notre modèle, nous pouvons regarder le résumé de notre modèle (disponible en Annexes : Modèle GLM pour fréquence n°= 1). On notera que les coefficients associés à l'intercept (une constante qui correspond à la valeur moyenne de ClaimInd lorsque toutes les variables sont nulles) et à l' "Exposure" sont trop importantes. 
...
|    La communication entre nous s’est faite via Messenger ou Discord, cela nous a permis d’échanger de manière instantanée et également d’avoir un historique des différents éléments que nous avions partagés.
