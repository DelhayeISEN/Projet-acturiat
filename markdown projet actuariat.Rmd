...
- Suppression de la colonne spécifiant si l'assuré peut prétendre ou non à une prime d'assurance (ClaimInd)
...
freMPL1 <- freMPL1[,c(1:17,19,18,20)]
```
...
- Poisson pour les fréquences des sinistres
